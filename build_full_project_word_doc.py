...
def create_full_documentation():
    ...
    if os.path.exists("assets/ui_dashboard.jpg"):
        p_img = doc.add_paragraph()
        p_img.alignment = WD_ALIGN_PARAGRAPH.CENTER
        p_img.paragraph_format.space_after = Pt(12)
        doc.add_picture("assets/ui_dashboard.jpg", width=Inches(6.0))
    ...
    if os.path.exists("assets/gesture_signs_poster.jpg"):
        doc.add_picture("assets/gesture_signs_poster.jpg", width=Inches(6.0))
        p_cap = doc.add_paragraph()
        p_cap.alignment = WD_ALIGN_PARAGRAPH.CENTER
    ...
    if os.path.exists("assets/plots/accuracy_graph.png"):
        doc.add_picture("assets/plots/accuracy_graph.png", width=Inches(5.5))
        p_cap = doc.add_paragraph()
        p_cap.alignment = WD_ALIGN_PARAGRAPH.CENTER
    ...
    if os.path.exists("assets/plots/simple_live_similarity.png"):
        doc.add_picture("assets/plots/simple_live_similarity.png", width=Inches(5.5))
        p_cap = doc.add_paragraph()
        p_cap.alignment = WD_ALIGN_PARAGRAPH.CENTER
        r_cap = p_cap.add_run("Figure 4: Live Hand Similarity Match Scores across 9 Gesture Classes")
        r_cap.font.size = Pt(9); r_cap.font.italic = True; r_cap.font.color.rgb = SLATE

    output_path = "AI_Gesture_Mouse_Full_Documentation.docx"
