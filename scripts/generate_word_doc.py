...
def create_documentation_docx():
    ...
    acc_loss_img_path = os.path.join(project_root, "results", "plots", "paper_accuracy_loss_section.png")
    if not os.path.exists(acc_loss_img_path):
        acc_loss_img_path = os.path.join(project_root, "assets", "plots", "paper_accuracy_loss_section.png")
    ...
    daily_img_path = os.path.join(project_root, "results", "plots", "daily_progress_chart.png")
    if not os.path.exists(daily_img_path):
        daily_img_path = os.path.join(project_root, "assets", "plots", "daily_progress_chart.png")
    ...
    similarity_img_path = os.path.join(project_root, "results", "plots", "simple_live_similarity.png")
    if not os.path.exists(similarity_img_path):
        similarity_img_path = os.path.join(project_root, "assets", "plots", "simple_live_similarity.png")
    ...
    output_doc_path = os.path.join(output_dir, "AI_Gesture_Mouse_Documentation.docx")
